...
const Tag = forwardRef<HTMLDivElement, TagProps>(({
    ...
    const prefixIconComp = prefixIconComponent ? prefixIconComponent : (prefixIcon ? <Icon name={prefixIcon} size="xs" /> : null);
    return (
        <Flex
            alignItems="center"
            radius="l"
